...
module.exports = {
 ...
 //   /*
        ...
        // GET BY LOGIN - obtener
        "usuario.getbylogin": async function (usr_login) {
            const sql = "Select * from usuario where usr_login = $1";
            const result = await client.query(sql, [usr_login]);
            return result.rows;
        },
        // GET ALL - LISTAR
        ...
        "usuario.update": async function (
            ...
            try {
                const sql = 'UPDATE usuario set usr_afl_id=$1,usr_login=$2,usr_password=$3,usr_estado=$4' +
                    "where usr_id=$5";
                const result = await client.query(sql, [
                    usr_afl_id,
                    usr_login,
        ...
        // DELETE BY ID - ELIMINAR
        "usuario.delete": async function (usr_id) {
            const sql = "DELETE FROM usuario WHERE usr_id = $1";
            const result = await client.query(sql, [usr_id]);
            return result;
        },
 //       */
